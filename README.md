...
##فایل نصب (Calculator.exe) برای اجرای ماشین حساب کافیست فایل Calculator.exe در هر دایرکتوری که دوست دارید کپی و اجرا کنید تا از ماشین حساب مهندسی تان لذت ببرید.
 32<br>
 <br>
